    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView style={{ flexGrow: 1 }}>
                ...
                <View style={styles.profileCard}>
                    <Text style={styles.profileDetailHeading}>Business Detail</Text>
                    <View style={styles.profileDetail}>
                        <Ionicons name='ios-business' size={20} color={Colors.PrimaryColor} />
                        <Text style={styles.profileText}>Name: {user?.biz_name}</Text>
                    </View>
                    <View style={styles.profileDetail}>
                        <Ionicons name='location' size={20} color={Colors.PrimaryColor} />
                        <Text style={styles.profileText}>Address: {user?.biz_address}</Text>
                    </View>
                    <View style={styles.profileDetail}>
                        <Ionicons name='calendar' size={20} color={Colors.PrimaryColor} />
                        <Text style={styles.profileText}>Date: {user?.biz_start_date}</Text>
                    </View>
                </View>
                <View style={styles.btnContainer}>
                    <TouchableOpacity style={styles.btn} onPress={() => { navigation.navigate("EditBAProfile", { userData: user }) }}>
