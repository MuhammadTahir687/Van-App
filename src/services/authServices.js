...
export const AuthServices = {
    ...
    CR_Register(body) {
        return axios.post("https://asia-south1.gcp.data.mongodb-api.com/app/registerapp-kvgyw/endpoint/insert/one_all?NameCollection=carRentalAgents", body)
    },
    CR_Login(body) {
    ...
    BA_Login(body) {
        return axios.post("https://eu-central-1.aws.data.mongodb-api.com/app/data_lookup-emecl/endpoint/LoginBizAdvertisers", body)
    ...
    TG_Login(body) {
        return axios.post("https://eu-central-1.aws.data.mongodb-api.com/app/data_lookup-emecl/endpoint/LoginGuide", body)
    }
}